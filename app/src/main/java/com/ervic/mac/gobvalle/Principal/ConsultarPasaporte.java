...
public class ConsultarPasaporte extends AppCompatActivity implements BottomNavigationView.OnNavigationItemSelectedListener{
    ...
    private String url = "http://qa-pidame.nexura.com/loader.php?lServicio=Pasaporte&lFuncion=consult&tipo=4";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        web_pagos = (android.webkit.WebView) findViewById(R.id.web_pasaporte);
