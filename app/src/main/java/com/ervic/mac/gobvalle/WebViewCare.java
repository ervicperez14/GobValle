    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        myWebView.setWebChromeClient(new WebChromeClient()
        {
            ...
            public void openFileChooser(ValueCallback<Uri> uploadMsg) {
                ...
                i.setType("image/*");
                try {
                    WebViewCare.this.startActivityForResult(Intent.createChooser(i, "Selecionar archivo"), FILECHOOSER_RESULTCODE);
            ...
            public boolean onShowFileChooser(android.webkit.WebView webView, ValueCallback<Uri[]> filePathCallback, FileChooserParams fileChooserParams) {
                ...
                try {
                    WebViewCare.this.startActivityForResult(Intent.createChooser(i, "File Chooser"), FILECHOOSER_RESULTCODE);
                }catch (ActivityNotFoundException e){
                    Toast.makeText(getApplicationContext(), "Ocurrío un error al abrir la gelería", Toast.LENGTH_LONG).show();
                    uploadMessage = null;
                    return false;
